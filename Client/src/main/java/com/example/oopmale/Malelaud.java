...
public class Malelaud {
    List<Malenupp> koikNupud = new ArrayList<>();
    List<Malenupp> valgedNupud = new ArrayList<>();
    List<Malenupp> mustadNupud = new ArrayList<>();
     ...
     * @return
     */
    boolean kaiguKatse(boolean valgeKaik, int vanaX, int vanaY, int uusX, int uusY){
        for (Malenupp malenupp : koikNupud) {
            if (!(malenupp.getX() == vanaX && malenupp.getY() == vanaY && malenupp.isOnValge() == valgeKaik)){
                continue;
            }
            if (!malenupp.kaiguDeltad().contains(List.of(uusX-vanaX, uusY-vanaY))){
                continue;
            }
            if (malenupp.getX() == uusX && malenupp.getY()==uusX && malenupp.isOnValge() == valgeKaik){
                return false;
            }
            return true;
        }
     ...
     * @param uusY
     */
    void teeKaik(int vanaX, int vanaY, int uusX, int uusY){
        for (Malenupp malenupp : koikNupud) {
            if (malenupp.getX() == uusX && malenupp.getY() == uusY){
                if (malenupp.isOnValge()) {
        ...
        for (Malenupp malenupp : koikNupud){
            if (malenupp.getX() == vanaX && malenupp.getY() == vanaY){
    ...
    int mangLabi(boolean valgeKaik){
        ...
        for (Malenupp malenupp : koikNupud) {
            if (malenupp.getClass() == Kuningas.class){
                if (malenupp.isOnValge()) valgeKuningas = true;
